...
type Akka.Actor.ITellScheduler with
    ...
    member this.ScheduleTellRepeatedly(after : TimeSpan, every : TimeSpan, receiver : ActorRef<'Message>, 
    ...
    /// <param name="message">Message to be sent to the receiver by the scheduler.</param>
    /// <param name="receiver">Message receiver.</param>
    member this.ScheduleTellOnce(after : TimeSpan, receiver : ActorRef<'Message>, message : 'Message) : unit = 
